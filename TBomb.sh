...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mRizwan Shoket \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Rizwan Shoket
    fi
    echo -e "\e[1;34m For Any Queries, Text me on Instagram!!!\e[0m"
    echo -e "\e[1;32m           @rizwan_shoket \e[0m"
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Rizwan Shoket > .update
